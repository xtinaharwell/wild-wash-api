...
MIDDLEWARE = [
    ...
    'api.middleware.DisableCSRFForApiMiddleware',  # Custom middleware for API CSRF handling
...
# CSRF settings - Configure for token-based authentication from frontend
